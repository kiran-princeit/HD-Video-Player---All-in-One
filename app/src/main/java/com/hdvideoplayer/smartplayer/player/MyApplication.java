...
import com.hdvideoplayer.smartplayer.player.adsprosimple.AdsConsentManager;
import com.hdvideoplayer.smartplayer.player.adsprosimple.RemoteAppDataModel;
import com.hdvideoplayer.smartplayer.player.BuildConfig;
...
public class MyApplication extends Application implements Application.ActivityLifecycleCallbacks, DefaultLifecycleObserver {
    ...
    public static final String TEST_DEVICE_HASHED_ID = "62F7119A1255D8CBC5BFE8C69BED52F2";
...
//                            Toast.makeText(activity, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT).show();
                        ...
                        public void onAdImpression() {
                            Log.d(LOG_TAG, "onAdImpression (Firebase log)");

                            // ✅ Firebase Impression Logging
