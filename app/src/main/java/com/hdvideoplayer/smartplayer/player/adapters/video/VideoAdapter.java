...
//    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        myViewHolder.ivChecked.setOnClickListener(v -> {
            ...
            if (mPlaylist != null) {
                ...
                ThreadExecutor.runOnDatabaseThread(() -> getActivatedClick(!isActivated, videoInfo, dateAdded));
            }
        });

        // Handle the "more" button click event
        myViewHolder.ivMore.setOnClickListener(view -> {
        ...
        viewHolder.itemView.setOnClickListener(new OnClickListener() {
            ...
            public final void onClick(View view) {
                if (!VideoAdapter.this.mIsSelectVideoMode || VideoAdapter.this.mPlaylist == null) {
                    ...
                    Log.e("TAG", "aaaaaaaaa: " + ((VideoInfo) VideoAdapter.this.mVideos.get(0)).getPath());
                    return;
                }
                ...
                ThreadExecutor.runOnDatabaseThread(new Runnable() {
                    public final void run() {
                        VideoAdapter.this.getActivatedClick(!isActivated, videoInfo, dateAdded);
                    }
                });
    ...
    public void getActivatedClick(boolean z, VideoInfo videoInfo, long j) {
