...
import com.hdvideoplayer.smartplayer.player.dialog.SortDialogBuilder.OkButtonClickListener;
...
public void onOkClick() {
    ...
    try {
        if (parse != null && "content".equals(parse.getScheme())) {
            ...
            throw new IllegalArgumentException("Invalid content URI: " + parse);
        }
        ...
        Log.e("MusicDelete", "Invalid URI: " + parse, e);
        Toast.makeText(mContext, "Cannot delete: Invalid file URI", Toast.LENGTH_SHORT).show();
    }
}
