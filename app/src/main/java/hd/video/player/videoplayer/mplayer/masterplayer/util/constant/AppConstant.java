package hd.video.player.videoplayer.mplayer.masterplayer.util.constant;
...
public final class AppConstant {
    ...
    public static class Themes {
        public static final int[] THEMES_STYLE = new int[]{R.style.Theme_HDVideoPlayerAllInOne_One};
    }
}
