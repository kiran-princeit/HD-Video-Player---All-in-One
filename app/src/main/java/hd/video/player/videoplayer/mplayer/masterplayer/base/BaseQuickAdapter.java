...
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.AlphaInAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.BaseAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.ScaleInAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.SlideInBottomAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.SlideInLeftAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.animation.SlideInRightAnimation;
import hd.video.player.videoplayer.mplayer.masterplayer.base.diff.BaseQuickAdapterListUpdateCallback;
import hd.video.player.videoplayer.mplayer.masterplayer.base.diff.BaseQuickDiffCallback;
import hd.video.player.videoplayer.mplayer.masterplayer.base.entity.IExpandable;
import hd.video.player.videoplayer.mplayer.masterplayer.base.loadmore.LoadMoreView;
import hd.video.player.videoplayer.mplayer.masterplayer.base.loadmore.SimpleLoadMoreView;
import hd.video.player.videoplayer.mplayer.masterplayer.base.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends Adapter<K> {
    ...
    public void setNewData(List<T> list) {
        if (list == null) {
            list = new ArrayList<>(); // Initialize with an empty list if null is passed
        }
        this.mData = list; // Assign the new data to mData

        // Reset the state for load more functionality if applicable
        if (this.mRequestLoadMoreListener != null) {
            this.mNextLoadEnable = true;
            this.mLoadMoreEnable = true;
            this.mLoading = false;
            this.mLoadMoreView.setLoadMoreStatus(1); // Update load more status
        }

        this.mLastPosition = -1; // Reset last position
